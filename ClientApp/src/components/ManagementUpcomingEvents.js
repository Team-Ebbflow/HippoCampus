...
export default function ManagementUpcomingEvents() {
    ...
    const getData = async () => {
        const response = await fetch('api/pages/eventall');
    ...
    const putData = async (id = -1, data = {}) => {
        ...
        const response = await fetch('api/pages/event&' + id, {
            method: 'PUT',
    ...
    const postData = async (data = {}) => {
        data = JSON.stringify(data);
        const response = await fetch('api/pages/event', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: data
        })
        ...
        <div className="app-container">
            ...
            <form onSubmit={handleAddFormSubmit}>
                ...
                <input
                    ...
                    name="time"
                    required="required"
                    placeholder="Enter Time (e.g. 18:30 am)..."
                    onChange={handleAddFormChange}
                />
